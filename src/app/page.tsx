export default function Home() {
  return (
    <main className="container-all w-full  bg-neutral-50">
      {/* Hero Section */}
      <section className="w-full sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 flex flex-col gap-4 items-center mx-auto py-[120px] lg:py-[160px] xl:py-[240px]">
        {/* Hero Header */}
        <div className="flex flex-col text-neutral-800 text-start">
          <h3 className="text-lg md:text-3xl lg:text-4xl italic">Sohyb</h3>
          <h3 className="text-5xl -mt-[32px] md:-mt-[62px] lg:-mt-[78px] md:text-8xl lg:text-9xl">
            MANSOUR
          </h3>
        </div>
        {/* Hero Buttons */}
        <div className="flex flex-wrap gap-4 gap-y-8 justify-center items-center max-w-[336px] lg:max-w-none">
          <a
            href="#skills"
            className="w-[108px] h-[108px] sm:w-[144px] sm:h-[144px] grid items-center text-center border-neutral-800 bg-white text-neutral-800 hover:bg-neutral-800 hover:text-neutral-50 border-solid border-[2px] text-xl sm:text-2xl duration-200"
          >
            Skills
          </a>
          <div className="rounded-full w-4 h-4 bg-neutral-800"></div>
          <a
            href="#projects"
            className="w-[108px] h-[108px] sm:w-[144px] sm:h-[144px] grid items-center text-center border-neutral-800 bg-white text-neutral-800 hover:bg-neutral-800 hover:text-neutral-50 border-solid border-[2px] text-xl sm:text-2xl duration-200"
          >
          ...
          <div className="rounded-full w-4 h-4 bg-neutral-800 hidden lg:block"></div>
          <a
            href="#about"
            className="w-[108px] h-[108px] sm:w-[144px] sm:h-[144px] grid items-center text-center bg-neutral-800 text-neutral-50  hover:bg-neutral-50 hover:text-neutral-800 border-solid border-[2px] border-neutral-800 text-xl sm:text-2xl duration-200"
          >
            About
          </a>
          <div className="rounded-full w-4 h-4 bg-neutral-800"></div>
      ...
      {/* Skills Section */}
      <section id="skills" className="default__section-styles">
        <h1 className="text-3xl lg:text-4xl text-center text-neutral-800">
          Skills & Technologies
        </h1>
        {/* Skills Container */}
        <div className="flex flex-wrap gap-4 items-center justify-center max-w-[912px]">
          {/* Individual Skills */}
          <div className="skill__styling">
            ...
            <h3 className="text-xl text-neutral-800">HTML</h3>
          </div>
          <div className="skill__styling">
            <svg
              className="w-[40px] md:w-[60px]"
            ...
            <h3 className="text-xl text-neutral-800">CSS</h3>
          </div>
          ...
          <div className="skill__styling">
            ...
            <h3 className="text-xl text-neutral-800">Javascript</h3>
          </div>
          <div className="skill__styling">
            <svg
              className="w-[40px] md:w-[60px]"
            ...
            <h3 className="text-xl text-neutral-800">Typescript</h3>
          </div>
          <div className="skill__styling">
            <svg
              className="w-[40px] md:w-[60px]"
            ...
            <h3 className="text-xl text-neutral-800">ReactJS</h3>
          </div>
          <div className="skill__styling">
            <svg
              className="w-[40px] md:w-[60px]"
            ...
            <h3 className="text-xl text-neutral-800">Tailwind</h3>
          </div>
          <div className="skill__styling">
            <svg
              className="w-[40px] md:w-[60px]"
            ...
            <h3 className="text-xl text-neutral-800">NextJS</h3>
          </div>
          <div className="skill__styling">
            <svg
              className="w-[40px] md:w-[60px]"
            ...
            <h3 className="text-xl text-neutral-800">Git</h3>
          </div>
          <div className="skill__styling">
            <svg
              className="w-[40px] md:w-[60px]"
            ...
            <h3 className="text-xl text-neutral-800">Github</h3>
          </div>
          <div className="skill__styling">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <h3 className="text-xl text-neutral-800">VSCode</h3>
          </div>
          <div className="skill__styling">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <h3 className="text-xl text-neutral-800">Figma</h3>
          </div>
          <div className="skill__styling">
            <svg
              className="w-[40px] md:w-[60px]"
            ...
            <h3 className="text-xl text-neutral-800">Prisma</h3>
          </div>
        </div>
      </section>
      {/* Projects Section */}
      <div className="w-full bg-neutral-800">
        <section id="projects" className="default__section-styles">
          <h1 className="text-3xl lg:text-4xl text-center text-neutral-50">
            Latest Projects
          </h1>
          {/* Projects Container */}
      ...
      {/* About Section */}
      <section id="about" className="default__section-styles">
        <h1 className="text-3xl lg:text-4xl text-center text-neutral-800">
          About me
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-8 w-full">
          ...
          <div className="flex flex-col lg:w-[484px]">
            {/* Label */}
            <h3 className="text-center text-xl text-neutral-50 py-1 px-4 bg-slate-700 w-full">
      ...
      <div className="w-full bg-slate-200">
        <section id="contact" className="default__section-styles">
          {/* Header */}
          <h1 className="text-3xl lg:text-4xl text-center text-neutral-800">
            Contact Me
          </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center justify-center w-full h-fit">
            ...
            <form className="flex flex-col gap-4 lg:w-[640px]" action="">
              ...
              <div className="flex gap-4 w-full">
                <input
                  placeholder="Name"
                  type="text"
                  className="w-full px-4 py-2 bg-neutral-50 border-neutral-400 border-solid border-[1px]"
                />
                <input
              ...
              <textarea
                placeholder="Message..."
                rows={5}
                className="px-4 py-2 bg-neutral-50 border-neutral-400 border-solid border-[1px]  resize-none"
              />
            ...
            <div className="flex lg:flex-col lg:items-start gap-8 flex-wrap justify-center w-auto text-neutral-800">
              ...
              <a
                ...
                className="flex gap-2 items-center justify-center fill-neutral-800 hover:text-blue-500 hover:fill-blue-500 duration-200"
              >
                <svg
                  className="w-[20px] fill-inherit"
                  xmlns="http://www.w3.org/2000/svg"
